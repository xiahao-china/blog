...
#mv ./uncompress-file/$mongosh_name $ENV_FILE_ROOT_PATH
#mv $mongosh_name mongosh
#echo "新增环境变量mongosh 到~/.bashrc"
#echo "
#alias mongosh=\"$ENV_FILE_ROOT_PATH/mongosh/bin/mongosh\"
#" >> ~/.bashrc
#echo "重新载入环境变量"
#source ~/.bashrc
...
mv ./uncompress-file/$mongotool_name $ENV_FILE_ROOT_PATH
mv $mongotool_name mongotool
echo "新增环境变量mongotool 到~/.bashrc"
echo "
alias mongodump=\"$ENV_FILE_ROOT_PATH/mongotool/bin/mongodump\"
alias mongoimport=\"$ENV_FILE_ROOT_PATH/mongotool/bin/mongoimport\"
" >> ~/.bashrc
echo "重新载入环境变量"
source ~/.bashrc
cd $ENV_FILE_ROOT_PATH
